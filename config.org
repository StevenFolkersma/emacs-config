...
This function should be improved. I think I should a wide and narrow
setup. Where toggling to narrow deleted all other windows. Also,
olivetti mode should be active for org buffers when in wide mode only.
...
Fully copied from [[https://protesilaos.com/emacs/dotemacs#h:efebaec4-7273-4c5a-a4c4-9f99df0e46bb][GNU Emacs configuration | Protesilaos]]
