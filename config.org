...
** TODO The =init.el= section on text styling and input
...
(setq org-publish-project-alist
      '(("recipebook-recipes"
         ...
         :publishing-directory "~/web/recipebook-org/docs/Maaltijden"
         :recursive t
         :with-toc nil
         :publishing-function org-md-publish-to-md)
        ("recipebook-images"
         :base-directory "~/Documents/Recipebook/Recipes/images"
         :publishing-directory "~/web/recipebook-org/docs/Maaltijden/images"
         :recursive t
...
** TODO The =init.el= section with center document mode
