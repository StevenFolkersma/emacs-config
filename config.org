...
** TODO The =dired-extras.el= section defining custom dired functions
...
** TODO The =denote-extras.el= section on custom denote functions
...
I am not sure how to require stuff should work yet.
Ideally you only load it when the function is called.
However, any require call inside a personal .el module will also be triggered, which can cause unwanted loading of function/packages.
Prot-pair does not have any require call, so it can be safely made here.
